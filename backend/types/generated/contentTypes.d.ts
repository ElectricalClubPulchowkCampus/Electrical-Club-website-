...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['workshop', 'seminar', 'competition', 'cultural', ' sports', ' other']
    >;
    ...
    organizer: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Text;
    clubContribution: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    led_projects: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status_project: Schema.Attribute.Enumeration<
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Committee', 'Sub-Committee']>;
    committee_members: Schema.Attribute.Relation<
      'oneToMany',
      'api::member.member'
    >;
    createdAt: Schema.Attribute.DateTime;
