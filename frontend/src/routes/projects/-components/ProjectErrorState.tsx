...
export function ProjectsErrorState({ error }: ProjectsErrorStateProps) {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
      ...
      <h3 className="text-xl text-foreground">Couldn't load projects</h3>
      <p className="text-sm text-muted-foreground mt-1 max-w-sm mx-auto">
        {error?.message || 'Something went wrong while fetching the projects. Try refreshing the page.'}
      </p>
